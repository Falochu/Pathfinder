...
\mbox{
    \subfigure{
        ...
        \textbf{Combat Maneuver} & +5 \\
        \textbf{Combat Defense} & 19 \\ \hline
        \\
        {\footnotesize \emph{Name}} & {\footnotesize \emph{Bonus}} &
        {\footnotesize \emph{Damage}} & {\footnotesize \emph{Critical}} \\
        \textbf{Longbow} & +9 & 1d8 & x3 \\
        \multicolumn{4}{l}{\emph{Piercing, 100 ft range}} \\
        \textbf{Rat's Tooth} & +11 & 1d6+2 & 19-20x2 \\
        ...
        \textbf{Acrobatics} & 5 & {\footnotesize DEX} & 1 \\
        \textbf{Appraise} & 2 & {\footnotesize INT} & - \\
        \textbf{Bluff} & 2 & {\footnotesize CHA} & - \\
        \textbf{Climb} & 8 & {\footnotesize STR} & 5 \\
        ...
        \textbf{Disable Device *} & 9 & {\footnotesize DEX} & 5 \\
    ...
    \subfigure{
        ...
        \textbf{Handle Animal *} & 9 & {\footnotesize CHA} & 4 \\
        \textbf{Heal} & 10 & {\footnotesize WIS} & 4 \\
        ...
        \textbf{Perception} & 11 & {\footnotesize WIS} & 5 \\
...
\mbox{
    \subfigure{
        ...
        \row{}{Light Fortified Studded Leather +1}{20}{}
        \row{}{Longbow}{3}{}
        \row{}{Rat's Tooth}{2}{}
        \row{}{Efficient Quiver}{}{}
        \row{7}{Fire Arrow +1}{-}{In}
        \row{30}{Blunt Arrow}{-}{In}
        \row{60}{Arrows}{-}{In}
        \row{}{Archery Gloves}{1}{}
        \row{}{}{}{}
        \row{}{}{}{}
        \row{}{}{}{}
        \hline
        \multicolumn{2}{r}{\textbf{Total:}} & \multicolumn{1}{c}{\textbf{25 lbs}} \\
...
\textbf{Kallus} Human Paladin 5 (Joe) \\
