...
\begin{tabu} to 0.5\textwidth[h]{X[3] X[1c]}
    ...
    \thing{Staff of Frost (24chg)}[20,700]
    &\\&\\
    \taburowcolors 2{white..white}
    \thing{}[\B{155,548}]
\end{tabu}
...
\B{24 April 2013} \e{WW} tracked us down and rejoined the group.  \e{Leaf} tested the D'Thrane guards by trying to sneak up in disguise, but was rebuffed.  The Inspector arrived in the district, looking for her brother, and requested we work together to find him. We agreed and leave the D'Thrane's estate to go to Merkel's to look, as it was really the only lead we had.  In the rubble of the shop, \e{WW} found tracks leading into the basement and to a wine cask: a hidden entrance like the one under the \e{C+C}. We followed the trail into the sewer, and though we quickly lost it, kept looking as we headed in the general direction of the Noble's district.  

We eventually came across signs of a struggle: broken teeth, fresh blood, et cetera.  Further along, the tunnel opened into a larger chamber with ladders up and a rusted door on one side.  \e{Leaf} picked the lock, and we followed that passage, distinctly less sewer-like, towards a literal light at the end of the tunnel. We heard screaming coming from the end, and upon arrival found the Captain being tortured on a rack by a large devil and a trio of cultists. Oblivious to any danger, \e{Lord Quentin} charged into battle to the cry of, ``We shall save you, Lady Butterbottom, from these were-penguins!'', and thus we find ourselves in a fight. Without too much strain, we dispatched cultist and devil alike.
