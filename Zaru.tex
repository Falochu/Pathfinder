...
%LVL6 Modify durations, ranges, and possibly other stuff at level-up time
\vspace{-0.5em}
\fullline
\vspace{-1.25em}
...
\spell{Detect Magic}{Full}{V S}{Divin}{Standard Action / 60ft range / 4 minute duration (D)}{
...
\spell{Read Magic}{Full}{V S F (a clear crystal prism)}{Divin}{Standard Action / Personal / 40 minutes**}{
...
\spell{Burning Hands}{}{V S}{Evoc}{Standard Action / 15ft Range / Instant / Reflex DC 15 Half}{%
Creatures in area take 5d4 fire damage, flammable materials in area are set on fire.}{}\\[-1em]

\spell{Charm Person}{}{V S M}{Ench}{Standard Action / 35ft Range / 5 hours / Will DC 15 \nolinebreak Negates}{%
...
\spell{Color Spray}{}{V S M}{Illu}{Standard Action / 15ft Range / Instant / Will DC 16 Negates}{%
...
\spell{Feather Fall}{}{V S}{Trans}{Immediate Action / 35ft Range / Until Landing or 5 rounds / Will DC 15 Negates (harmless)}{%
...
\spell{Floating Disk}{}{V S M}{Evoc}{Standard Action / 35ft Range / 5 hour duration}{%
...
\spell{Sleep}{}{V S M}{Ench}{Full Round Action / 150ft Range / 10ft Radius Burst / 5 minute duration / Will DC 15 \nolinebreak Negates}{%
...
Ranged touch attack deals 2d4 acid damage, plus 2d4 more damage 1 round later}{}\\[-1em]
% Additional duration/damage at 6/9/12/15/18th level, see core rulebook p239

\spell{Bear's Endurance}{}{V S M}{Trans}{\mbox{Standard Action / Touch / 5 minute duration / Will DC 16 Negates (harmless)}} {%
...
\spell{Bull's Strength}{}{V S M}{Trans}{\mbox{Standard Action / Touch / 5 minute duration / Will DC 16 Negates (harmless)}}{%
\mbox{Target gains +4 enhancement bonus to Strength (add usual benefits to melee attack/damage rolls, et cetera).} }{}\\[-1em]

\spell{Cat's Grace}{}{V S M}{Trans}{\mbox{Standard Action / Touch / 5 minute duration / Will DC 16 Negates (harmless)}}{%
...
\spell{Hypnotic Pattern}{}{S M}{Illu}{\mbox{Standard Action / 150ft range / 10ft radius spread / concentration + 2 rounds / Will DC 16 Negates }}{%
...
%LVL6 Target benefits from 50\% miss chance. May be negated by \emph{True Seeing}.}{}\\[-1em]
...
Cause a small symbol to appear in a written work or at least 25 words in length.  Anyone who reads the text triggers the spell, causing a large sepia snake to spring into being.  Target that fails to save is engulfed in an amber force field and immobilized for 1d4+4 days, or until you release them.  While immobilized, the target does not age, breathe, grow hungry, sleep, or regain spells: it is in a state of suspended animation.  It can be affected by its surroundings, but is unaware of them.  A \emph{detect magic} spell does not reveal this spell, only that the text is magical.  A \emph{dispell magic} spell can remove this sigil.  The \emph{erase} spell destroys the entire page of text.  This spell may be cast in combination with other text-affecting spells, such as \emph{secret page}.}{5em}\\[-1em]
