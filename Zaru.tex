...
\B{13 March 2013} \e{Mage's Point}, and its fields, livestock, and people, had all appeared back in their normal locations. Mayor Fergus and his people were immensely grateful.  We decided to investigate the tower of the hamlet's namesake, and found it rotting and broken, unlike in the shadow realm.  We climbed in through a window, and after searching awhile, found a \e{Globe of Sounding}.

Back in town, we met \e{Count Seavos}, who took us back to his fortress, \e{Seran}.  He thanked us and promised several rewards: a promissory note valued at 8000 axes within \e{Horngrim}, a feast, and access to both his counsellor and his castle's hot springs. On the way, we passed the ruins of one of the Mad Count's forts.  On arrival, the count introduced his family; his Lady was clearly not the mother of his children. \e{Pellagius} and \e{Leaf} went to the hot baths while \e{Z}, \e{Sajitz}, and \e{Clay} visit the library and meet counselor \e{Lork}.  \e{Clay} read up on golden gorgers and rust monsters, while \e{Z} and \e{Sajitz} discovered writings from which they pieced together a theory that the Mad Count was influenced by a magical helm. We all attended a great feast in our honor; one of the count's children confides that she believes something is wrong with her father, that he is not himself to have cast aside the children's mother for such a young replacement.
\end{notesection}
\end{document}
