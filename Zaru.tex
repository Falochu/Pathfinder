...
% Shorthand command for frequent use and/or for hard to remember sequences 
...
\mbox{
    \subfigure{
        ...
        \multicolumn{4}{l}{\e{Piercing}} \\\hline
...
\begin{tabu} to 0.5\textwidth[h]{X[3] X[1c]}
    ...
    \thing*{2 Scroll of \e{Behir Lightning}\N CL 7}\hline
    \thing{}[\B{21/22.5}]
    \multicolumn{2}{r}{Med 46, Heavy 68.5, Lift 137, Push/Drag 342.5}
    \\[23em]
\end{tabu}
\begin{tabu} to 0.5\textwidth[h]{X[3] X[1c]}
\thing{\B{\e{New Middleton} Storage}}[\B{Value}]
\thing{2 Draft Horses and Cart}
    ...
    \thing{6 Silver Trade Bars}[20]\hline
    \thing{}[\B{17,991}]
    \\
    \thing{\B{Party Loot and Supplies}}[\B{Value}]
...
\begin{tabu} to 0.5\textwidth[h]{X}
    ...
    \B{Leaf} Half-Elf Rogue 6 (Patrick)\\[1.5em]
\end{tabu}
\begin{tabu} to 0.5\textwidth[h]{X}
...
$^\dag$ Ray spell: benefits from weapon focus (ray) \\
