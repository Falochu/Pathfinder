...
\usepackage[usenames,dvipsnames,table]{xcolor} % Import set of color names, like "Plum"
...
\definecolor{pathfinder-tan}{RGB}{224,223,151}
...
\multicolumn{4}{l}{* Includes bonus from \e{Arcane Strike}} \\[13em]
\end{tabu}
%
%\definecolor{actualwhite}{RGB}{255,255,255}
%\taburowcolors[4] 2{pathfinder-tan..actualwhite}
...
Two ranged touch attacks deal 4d6*1.5 fire damage each to their target(s).}{}\\[-1em] %Close (25ft+5ft/2lvl). LVL11 increase to three rays
