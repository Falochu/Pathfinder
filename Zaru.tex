...
\mbox{
    ...
    \subfigure{
        ...
        \textbf{Climb} & -1 & {\footnotesize STR} & - \\
        \hline
        \textbf{Concentration} & 9 & {\footnotesize INT} & 5 \\
        ...
        \hline
        \textbf{Knowledge {\scriptsize ARCANA} *} & 12 & {\footnotesize INT} & 5 \\
        ...
        \textbf{Knowledge {\scriptsize HISTORY} *} & 12 & {\footnotesize INT} & 5 \\
        \hline
        ...
        \textbf{Perception} & 6 & {\footnotesize WIS} & 5 \\
        ...
        \textbf{Spellcraft *} & 12 & {\footnotesize INT} & 5 \\
        \textbf{Stealth} & 7 & {\footnotesize DEX} & 5 \\
        \hline
        \textbf{Survival} & 1 & {\footnotesize WIS} & - \\
        \textbf{Swim} & -1 & {\footnotesize STR} & - \\
