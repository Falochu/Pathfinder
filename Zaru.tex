...
\noindent\textbf{The North Circle} A group of spellcasters in the Seven Setltements and the North, consisting of \emph{Z} and: \\
\indent\person{Zachary Bj\"{o}rtfiskur}{M}{Gnome Wizard} \emph{Z}'s Uncle \\
...
\vspace{-1.75em}
\fullline
\noindent - \emph{Z} has Ogre Mage's spellbook containing: Summon Monster II, Detect Thoughts
