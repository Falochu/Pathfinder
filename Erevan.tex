...
\begin{tabu} to 0.5\textwidth[h]{X[3] X[1c]}
    ...
    \thing{42pp, 30gp, 500sp}
    \thing{670gp store credit}
    \thing{12 pea-sized diamonds}
    \thing{dragonborn-sized plate mail}
    \thing{2 healing potions}
    \thing{1 better healing potion}
